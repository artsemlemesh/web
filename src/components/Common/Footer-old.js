          ...
          <div className="row">
            <div className="col-lg-4 col-md-12 col-sm-12">
              <div className="widget">
                ...
                <p className="mb-3">Baby & Toddler Clothing Bundles</p>
                  ...
                  <div className="col-md-4">
                    <div className="icon_box icon_box_style2">
                      ...
                      <div className="icon_box_content">
                        <h5>Free Delivery</h5>
                        <p>Most bundles qualify for Free Delivery. Order today!</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="icon_box icon_box_style2">
                      ...
                      <div className="icon_box_content">
                        <h5>Get Paid Fast</h5>
                        <p>Sell your old baby and toddler clothing and get paid fast!</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="icon_box icon_box_style2">
                      ...
                      <div className="icon_box_content">
                        ...
                        <p>We have your back. Let us know how we can help with your order.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-4">
              <p className="mb-lg-0 text-center">© Bynde, Inc. All rights reserved.</p>
            </div>
