  ...
  function d(b, p, q) {
    ...
    function L(a, b, c) {
      if (Rb && cc.released && !c) {
        ...
        Qb
          ? (e && (a = Ib[d.centerItem].center), Pb && rb.activateMiddle && T(d.centerItem))
        ...
        ac.immediate
          ...
          ? ((ac.tweeseDelta = ac.to - yb.cur),
            D(ac.tweeseDelta) < 0.1
              ? (yb.cur = ac.to)
              : (yb.cur += ac.tweeseDelta * (cc.released ? rb.swingSpeed : rb.syncSpeed)))
          : ((ac.time = I(+new Date() - ac.start, rb.speed)),
            (yb.cur =
              ac.from +
              ac.delta * a.easing[rb.easing](ac.time / rb.speed, ac.time, 0, 1, rb.speed))),
          ac.to === yb.cur ? ((yb.cur = ac.to), (cc.tweese = ec = 0)) : (ec = t(M)),
          ob('move'),
          tb ||
            (m
              ? (vb[0].style[m] =
                  n + (rb.horizontal ? 'translateX' : 'translateY') + '(' + -yb.cur + 'px)')
    ...
    function N() {
      Ab.length &&
        ((Db.cur =
          yb.start === yb.end
            ? 0
            : (((cc.init && !cc.slidee ? yb.dest : yb.cur) - yb.start) / (yb.end - yb.start)) *
              Db.end),
        ...
        _b.hPos !== Db.cur &&
          ...
          m
            ? (Ab[0].style[m] =
                n + (rb.horizontal ? 'translateX' : 'translateY') + '(' + Db.cur + 'px)')
      ...
      if (
        ...
        null != Jb.activeItem &&
          (a === Jb.activeItem
            ...
            : Jb.activeItem > d && Jb.activeItem < e && (_b.active = Jb.activeItem += f ? 1 : -1)),
          K();
      }
    }
    function Y(a, b) {
    ...
    function lb(a) {
      return eb(this)
        ...
        : void (this.parentNode !== vb[0] || a.originalEvent[r + 'ignore'] || sb.activate(this));
    }
    function mb() {
        ...
        a &&
          (Rb
            ? sb[Qb ? 'toCenter' : 'toStart'](
                k((Qb ? Jb.centerItem : Jb.firstItem) + rb.scrollBy * a, 0, Ib.length),
              )
            : L(yb.dest + a, b));
      }),
      ...
      (sb.add = function (b, c) {
        ...
        Rb
          ? (null == c || !Ib[0] || c >= Ib.length
            ...
            null != Jb.activeItem && c <= Jb.activeItem && (_b.active = Jb.activeItem += d.length))
          : vb.append(d),
          K();
      }),
      ...
      (sb.init = function () {
        if (!sb.initialized) {
          ...
          return (
            ...
            m
              ? n && e.css(m, n)
              : ('static' === zb.css('position') && zb.css('position', 'relative'),
  ...
  u.on(y, function (a) {
    ...
    (a.fn[p] = function (b, c) {
      ...
      return (
        a.isPlainObject(b) ||
          (('string' === e(b) || b === !1) &&
            ((f = b === !1 ? 'destroy' : b), (g = Array.prototype.slice.call(arguments, 1))),
          (b = {})),
